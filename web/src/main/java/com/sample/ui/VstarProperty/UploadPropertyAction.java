...
public class UploadPropertyAction extends ActionSupport {
	...
	public String save() {
		boolean savedSuccess = propertyUploadProcess
				.savePropertyWithUserDetails(propertyFeatureInfo);
		return SUCCESS;
	}
	...
	public void setPropertyUploadProcess(
			PropertyUploadProcess propertyUploadProcess) {
